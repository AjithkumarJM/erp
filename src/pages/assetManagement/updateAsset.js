...
import { getStatusList, getTypeList, updateAsset, getAvailableAssets } from './../../actions'
...
class UpdateAsset extends Component {
    ...
    submit(values) {
        ...
        this.props.updateAsset(values, (data) => {
        ...
        return (
            <div>
                ...
                <div className="row justify-content-md-center ">
                    <div >
                        <button type='submit' onClick={handleSubmit(this.submit.bind(this))} className="btn-spacing btn btn-sm btn-ems-primary" disabled={pristine || submitting}>Update</button>
                    </div>
                </div >
            </div>
        )
...
})(connect(null, { getStatusList, getTypeList, updateAsset, getAvailableAssets })(UpdateAsset));