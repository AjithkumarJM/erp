...
export default class AssetManagementHome extends Component {
    ...
    renderNavLinks = () => {
        ...
        if (pathname === '/asset_management/create_asset' || pathname === '/asset_management/create_asset/' || pathname === '/asset_management/update_asset/' || pathname === '/asset_management/update_asset') return null
        return (
            <div>
